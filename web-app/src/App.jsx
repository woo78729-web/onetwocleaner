...
const AdminAccountingPage = lazy(lazyRetry(() => import('./pages/AdminAccountingPage')));
const AdminPerformancePage = lazy(lazyRetry(() => import('./pages/AdminPerformancePage')));
const AdminStaffPage = lazy(lazyRetry(() => import('./pages/AdminStaffPage')));
const AdminSchedulesPage = lazy(lazyRetry(() => import('./pages/AdminSchedulesPage')));
const AdminRegionalSchedulingPage = lazy(lazyRetry(() => import('./pages/AdminRegionalSchedulingPage')));
const AdminLeaveCalendarPage = lazy(lazyRetry(() => import('./pages/AdminLeaveCalendarPage')));
const AdminScheduleDayPage = lazy(lazyRetry(() => import('./pages/AdminScheduleDayPage')));
const AdminProjectsPage = lazy(lazyRetry(() => import('./pages/AdminProjectsPage')));
const EmergencyMaintenancePage = lazy(lazyRetry(() => import('./pages/EmergencyMaintenancePage')));
const PhoneLookupPage = lazy(lazyRetry(() => import('./pages/PhoneLookupPage')));
const MaintenanceRecordsPage = lazy(lazyRetry(() => import('./pages/MaintenanceRecordsPage')));
const MailTrackingPage = lazy(lazyRetry(() => import('./pages/MailTrackingPage')));
const RemittanceTrackingPage = lazy(lazyRetry(() => import('./pages/RemittanceTrackingPage')));
const EmployeeTodayTasksPage = lazy(lazyRetry(() => import('./pages/EmployeeTodayTasksPage')));
const EmployeeCalendarPage = lazy(lazyRetry(() => import('./pages/EmployeeCalendarPage')));
const EmployeeDailyReportPage = lazy(lazyRetry(() => import('./pages/EmployeeDailyReportPage')));
const EmployeeReportHistoryPage = lazy(lazyRetry(() => import('./pages/EmployeeReportHistoryPage')));
const EmployeeMonthlySummaryPage = lazy(lazyRetry(() => import('./pages/EmployeeMonthlySummaryPage')));
const EmployeeMaintenanceReportPage = lazy(lazyRetry(() => import('./pages/EmployeeMaintenanceReportPage')));
const EmployeeLeavePage = lazy(lazyRetry(() => import('./pages/EmployeeLeavePage')));
const EmployeeSettingsPage = lazy(lazyRetry(() => import('./pages/EmployeeSettingsPage')));
const EmployeeOnboardingPage = lazy(lazyRetry(() => import('./pages/EmployeeOnboardingPage')));
const EmployeeRulesPage = lazy(lazyRetry(() => import('./pages/EmployeeRulesPage')));
